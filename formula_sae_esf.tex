...
\section{Accumulator}
   ...
   In software, we are restricting the maximum cell temperature (charging) to 50 \degree C, and the maximum cell temperature (discharging) to 60 \degree C.
        ...
        \subsubsection{Cell Configuration} \label{cellconfiguration}
            ...
            \hlr{There are 3 maintenance plugs, separating the segments to be less than 6 MJ each. Figure }\ref{tswiringtop} \hlr{ points out the maintenance plugs, shortened as \hlr{SMD or MSD. The connectors are further described in section} \ref{batteryconnectors}.
