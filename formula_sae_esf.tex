...
\section{Motors} \label{Motors}
    ...
    \subsection{Motor 1} \label{M1}
        ...
        \subsubsection{Wiring, Cables, Current Calculations, Connectors} \label{motorswiring}
            ...
            \hlr{Connections from the motors to motor controllers will be encased in UL-listed conduit, which will be properly terminated at each end to provide proper strain relief. The connections from the accumulator to the motor controllers are shielded dual-insulated $35mm^{2}$ stranded wire pigtails from a Delphi Shield-Pack HV2000 connector, which will be strain relieved at the motor controller using wire glands. The shielding will be properly grounded at the motor controller side using industry standard practices. The shielding is grounded internal to the connector on the accumulator-side connection.}
