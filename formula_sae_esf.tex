...
\section{Accumulator}
   ...
   In software, we are restricting the maximum cell temperature (charging) to 50 \degree C, and the maximum cell temperature (discharging) to 60 \degree C.
        ...
        \subsubsection{Cell Configuration} \label{cellconfiguration}
            ...
            \hlr{There are 3 maintenance plugs, separating the segments to be less than 6 MJ each. Figure }\ref{tswiringtop} \hlr{ points out the maintenance plugs, shortened as SMD or MSD. The connectors are further described in section} \ref{batteryconnectors}.
        ...
        \subsubsection{Wiring, Cables, Current Calculations, Connectors} \label{batteryconnectors}
            ...
            The high current (motor, motor controller) wires used for the tractive system will be as described in table \ref{accumtomcwire} and \ref{motortomc}.
        ...
        \subsubsection{Wiring, cables}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|l|l|}
                    ...
                    I2t rating & None listed, see figure \ref{glv1Afusemeltingtime} \\ \hline
                    \end{tabular}
...
\begin{figure}[H]
    \centering
    \includegraphics{1AGLVlowratings}
