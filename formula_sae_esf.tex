...
\section{Electrical Systems}
    ...
    \end{table}
        ...
        \subsubsection{Wiring/Cables/Connectors}
            ...
            \hlr{The Inertia switch will be wired to be normally closed and open the shutdown circuit in the case that there is a crash. }
...
\section{Accumulator}
   ...
   In software, we are restricting the maximum cell temperature (charging) to 50 \degree C, and the maximum cell temperature (discharging) to 60 \degree C.
        ...
        \subsubsection{Cell Configuration} \label{cellconfiguration}
            ...
            Busbars connect the modules in series, as shown in Figure \ref{busbar}. The busbars connecting module to module are copper with a cross-section of $60.5 mm^2$, which exceeds the required wire gauge for tractive system lines (2 gauge). \hlr{The blue squares seen in figure} \ref{busbar} \hlr{are the cell top boards.}

            \begin{figure}[H]
                \centering
                \includegraphics[width = 0.6 \textwidth]{nothermistors_frontview}
        ...
        \subsubsection{Accumulator Insulation Relays (AIR)} \label{airs}
            ...
            \hlr{The AIRs and main fuse are in a separate compartment of the accumulator separated by two layers of insulating G10/FR4 fiberglass and a single layer of 0.035” 301 stainless steel, as shown in} \ref{accumlocations}.
        ...
        \subsubsection{Fusing} \label{fusing}
            ...
            TS+ to GLV DC-DC converter & \hlr{20 AWG} & 7A & \hlr{MIN fuse} & 4A \\ \hline
        ...
        \subsubsection{Mechanical Configuration/Materials}
            ...
            \hlr{The accumulator is mounted to the chassis using 10 SAE Grade 5 5/16” bolts through welded, gusseted tabs.}
