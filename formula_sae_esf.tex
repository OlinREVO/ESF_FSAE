...
\section{Accumulator}
   ...
   In software, we are restricting the maximum cell temperature (charging) to 50 \degree C, and the maximum cell temperature (discharging) to 60 \degree C.
        ...
        \subsubsection{Wiring, Cables, Current Calculations, Connectors} \label{batteryconnectors}
            ...
            The low current (IMD, Lights DC-DC, GLV DC-DC and ready to drive sound) TS connections will be made with the wire described in table \ref{tslowcurrentwire}. \hlr{The low current connections will be protected with a 1A fuse.}
