...
\section{Accumulator}
    ...
    \subsection{Accumulator Pack 1} \label{Battery1}
        ...
        \subsubsection{Overview/Description/Parameters} \label{batteryoverview}
            ...
            The Olin REVO team is under NDA with Nissan surrounding the information of the Nissan Leaf cells. The information of the cell capacity and nominal voltage are shareable without NDA.
            ...
            The maximum voltage is calculated from the maximum charging voltage, (4.15V per cell), and the maximum charging current is the maximum of the charger. Both are safe parameters for our cells.
        ...
        \subsubsection{Cell Description} \label{celldescription}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|l|l|}
                    ...
                    Maximum Voltage & NDA \\ \hline
                    Nominal Voltage & 3.75V \\ \hline
                    Minimum Voltage & NDA \\ \hline
                    Maximum output current & Unknown \\ \hline
                    Maximum nominal output current & NDA \\ \hline
                    Maximum charging current & NDA \\ \hline
                    Maximum Cell Temperature (discharging) & NDA, see below \\ \hline
                    Maximum Cell Temperature (charging) & NDA, see below\\ \hline
                    Cell Chemistry &
                        \begin{tabular}[c]{@{}l@{}}
   ...
   In software, we are restricting the maximum cell temperature (charging) to 50 \degree C, and the maximum cell temperature (discharging) to 60 \degree C.
        ...
        \subsubsection{Cell Configuration} \label{cellconfiguration}
            ...
            As stated in Section \ref{batteryoverview}, there are 12 modules in series. Each module holds 4 cells which are in a 2s-2p configuration. The terminal marked in white in Figure \ref{canopener} references the point between the two parallel cell strings. The white terminal is the cell interconnection point, as shown in figure \ref{module}.
            ...
            There are 3 maintenance plugs, separating the segments to be less than 6 MJ each. Figure \ref{tswiring_top}  points out the maintenance plugs, shortened as SMD or MSD. The connectors are further described in section \ref{batteryconnectors}.
        ...
        \subsubsection{Battery Management System} \label{bms}
           ...
           There are 4 AMS modules, and each AMS monitors 6 groups of cells in series. Each module contains 4 cells, 2 series x 2 parallel, so each AMS monitors 3 modules, or 12 cells (6 series x 2 parallel). There are 4 AMS boards. Each AMS board is coupled to a cell breakout board, which includes 3 thermistors and bolts to the power terminals of three modules, as shown in Figure \ref{busbar} (blue circuit boards). The purpose of the cell breakout boards is to help manage wiring inside the accumulator. The cell breakout boards will have compression limiting copper pads at the terminal bolts and will be spaced above the bus bars using copper washers.\\
            ...
            The AMS is able to shunt 3A when the cell voltage gets above 4.15 V. The AMS opens a relay in line with the shutdown circuit if any cell drops below 2.5 V or above 4.15V. The AMS opens a relay in line with the shutdown circuit if any cell gets above 60 \degree C. The power to each of the AMS relays is through a CAN output, and the CAN system does monitor all of the voltage and temperature.\\
            ...
            %Describe the fuses used and their main operation parameters, use tables, etc.
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{|l|l|}
                        ...
                        \end{tabular} & $300$A at $125$VDC \\ \hline
                    \end{tabular}
        ...
        \subsubsection{Charging} \label{charging}
            ...
            This UL-listed charger supplies constant current at 17.0A until cell voltages reach 4.15V. Then, constant voltage is supplied at 4.15 V \hlr{per cell, summing to 99.6V,} until the current tapers to 2.0 A. The charging power lines will be fused to 20A to protect the  12 AWG wiring.\\
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width = 0.7 \textwidth]{Cart}
...
\section{Additional LV-parts Interfering with the Tractive System}
    ...
    \subsection{LV Part 1: DC-DC converter and GLV battery}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|l|l|}
            \hline
            Fuse manufacturer and type: & Littledfuse, MINI Series (MIN2BP) \\ \hline
            ...
            \end{tabular}
            \caption{GLV battery and GLV DC-DC fuses, MIN type}
            \label{glvfusetable}
        \end{table}
