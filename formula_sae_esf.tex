 ...
 The brake sensor is Pegasus Racing P/N 3601 pressure switch that activates between 60 and 120psi. It is attached to the brake line using a -3 AN T-fitting. The brake system is composed of a combination of hard and flexible brake line and will use a combination of SAE flare connections and AN fittings.
    ...
    \subsection{Tractive system Active Light}
        ...
        \subsubsection{Wiring/Cables/Connectors}
            ...
            All connections made by wires will be 20 AWG rated for 600V, 125 \degree C and 7A, while all PCB traces will be a minimum of 12 mil, but nominally 20 mil in width. The TS voltage will have been fused to 1A on both \hlr{the positive and negative TS poles, with the same fuses that protects the TSMPs, IMD and R2D sound (fuses located on the AIR control board PCB). It is within the low current TS voltage harness, which connects to the 8-pin Ampseal on the side panel PCB.}
...
\section{Accumulator}
    ...
    \subsection{Accumulator Pack 1} \label{Battery1}
        ...
        \subsubsection{Cell Configuration} \label{cellconfiguration}
            ...
            There are 3 maintenance plugs, separating the segments to be less than 6 MJ each. Figure \ref{tswiring_top} points out the maintenance plugs, shortened as SMD or MSD. \hlr{ The maintenance plugs were donated by GM and used (OEM) in the Gen2 Volt as its MSD. The calculation verifying the segment energy is seen below}.
        ...
        %doesn't the accumulator indicator need to be run off of AIR control voltage? The pertinent rule is EV 3.3.9. The DC-DC can be powered without the AIR's being %closed.
            ...
            As shown in Figure \ref{aischem}, the zener diode allows TS voltage to pass through the accumulator indicator LED and a resistor after TS voltage is over 60 VDC. \hlr{The high voltage line }  U148 is a 220 Ohm resistor to limit current. The calculations are as follows, assuming a forward voltage drop of the LED to be 2V:
            ...
            The accumulator indicator is located on the AIR control board PCB, and has traces of 20 mil, which are rated for 1.4A. \hlr{The accumulator indicator is behind the 1A fuses protecting the high voltage low current harness - the same as the TSAL and IMD.}
...
\section{Energy Meter Mounting}
    ...
    \subsection{Description}
        ...
        \begin{figure}[H]
            ...
            \caption{Electrical connections of the energy meter}
            \label{EMschem}
        \end{figure}
