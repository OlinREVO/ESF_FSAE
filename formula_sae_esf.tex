...
\section{Accumulator}
    ...
    \subsection{Accumulator Pack 1} \label{Battery1}
        ...
        \subsubsection{Cell Configuration} \label{cellconfiguration}
            ...
            There are 3 maintenance plugs, separating the segments to be less than 6 MJ each. Figure \ref{tswiring_top} points out the maintenance plugs, shortened as SMD or MSD. The connectors are described in full detail in section \ref{batteryconnectors} as OEM maintenance plugs donated by GM. \hlr{The calculation verifying the segment energy is seen below}.
...
\section*{11.3.1.3 Cell Configuration} \label{cellconfigurationappendix}
