...
\section{Additional LV-parts Interfering with the Tractive System}
    ...
    \end{table}
        ...
        \subsubsection{Position in Car}
            ...
            Figure \ref{dcdc_cad} shows the CAD model of the DC-DC converter, which will be located in the \hlr{motor controller} housing described in figure \ref{cpanel2} along with the glv battery.
