...
\begin{itemize}
    ...
    \item \hl{NDA - Non Disclosure Agreement}
\end{itemize}
...
\section{System Overview} %Short description of system's concept
    ...
    See Figure \ref{tractive} for an electrical block diagram.
        ...
        \begin{sidewaysfigure}[p]
            ...
            \caption{\hl{Tractive system block diagram}}
            \label{tractive}
        \end{sidewaysfigure}
        ...
        \begin{table}[H]
            ...
            \hline
                ...
                Control-system voltage & 13.5VDC \hl{\& 12VDC}\\ \hline
                Accumulator configuration & 2s2p in 12s \\ \hline
                Total Accumulator capacity & \hl{NDA} \\ \hline
                Motor type & Brushless DC Motor \\ \hline
                Number of motors & Total: 2 \\ \hline
                Maximum combined motor power in kW & \hl{NDA} \\ \hline
            \end{tabular}
...
\section{Electrical Systems}
    ...
    \subsection{Shutdown Circuit}
        ...
        \subsubsection{Description/Concept}
            ...
            \begin{table}[H]
                ...
                \hline
                    ...
                    Brake over travel switch (BOTS) & \h{Push-pull button} \\ \hline
        ...
        \subsubsection{Wiring/Additional Circuitry}
            ...
            \begin{figure}[H]
                ...
                \caption{\hl{Shutdown Circuit Switches}}
                \label{switchesonly}
            \end{figure}
            ...
            \begin{table}[H]
                ...
                \hline
                    ...
                    Current per AIR & \hl{ 3.8A until 150 ms passes, then 0.4 A} \\ \hline
                    Additional parts consumption within the shutdown circuit: & \hl{0.5 A }\\ \hline
                    Total current: & \hl{4.3 A until 150 ms passes, then ~1A} \\ \hline
            ...
            The GLV system also has 12V and 5V supply lines in parallel to the shutdown circuit. It supplies the 555 timers, CAN nodes, coils and lights, \hl{ which are all in parallel with the AIRs, increasing the total current to 1A. }
    ...
    \subsection{IMD}
        ...
        \subsubsection{Description (Type, Operation Parameters)}
            ...
            The IMD used will be a Bender A-ISOMETER \hl{IR155-3204}. The output is normally low and only high if it does not detect a ground fault. The output is then used in a 3PDT relay to power both the indicator light and closes the switch in the shutdown circuit.
            %Need to include set point of ground fault
            %Where is the IMD light voltage coming from?
        ...
        \subsubsection{Wiring/Cables/Connectors}
            ...
            Due to the low current draw of the IMD and its low maximum current, all wire gauges connecting to the IMD will be 22 AWG. \hl{There is a fuse protecting the low current, high voltage wiring of the IMD and other components, and it is fused to 1A. }

            \begin{figure}[H]
                \centering
                \includegraphics[width = 1 \textwidth]{Only_IMD}
                \caption{\hl{Schematic of the IMD and its connections}}
                \label{IMD}
            \end{figure}
            
            The IMD output powers a four pole double throw relay. However, for the relay to become powered, each time the shutdown system wants to close, a person must press the IMD reset button, which closes the circuit and allows the coil to power itself through the first pole. \hl{The other two poles close the shutdown circuit and the input pin to the CAN node. The fourth pole is not connected. The can input will inform the CAN system about the status of the IMD. The Atmega controls the IMD light in the cockpit through CAN software. With the coil powered from the IMD's positive output, the shutdown circuit will close. }

            The connectors used for the IMD are the TYCO-MICRO MATE-N-LOK 1 x 2-1445088-8 and its mate. %% this needs to have 18 AWG wire
    ...
    Supply voltage range & \hl{12} VDC \\ \hline
    Supply voltage & 12VDC \\ \hline
    ...
    \end{table}
        ...
        \subsubsection{Wiring/Cables/Connectors}
            ...
            The Inertia switch will be wired to be normally closed and open in the case that there is a crash. The switch will be wired according to Figure \ref{wiringinertia}. The normally closed switch will close the shutdown circuit. 
            ...
            \begin{figure}[H]
                ...
                \caption{Schematic of the inertia switch and references to where it is in the shutdown circuit}
                \label{inertia}
            \end{figure}
 ...
 The brake sensor is Pegasus Racing P/N 3601 pressure switch that activates between 60 and 120psi. It is attached to the brake line using a -3 AN T-fitting. The brake system is composed of a combination of hard and flexible brake line and will use a combination of SAE flare connections and AN fittings.
    ...
    \subsection{Reset/Latching for IMD and BMS}
        ...
        \subsubsection{Wiring/Cables/Connectors}
            ...
            The connectors used will be Molex, LLC 0022013037 and its pair, Molex, LLC 0022232031, or other Molex products of the same series but with a different number of headers on each side of the connector. 
    ...
    \subsection{Shutdown System Interlocks} \label{interlocks}
        ...
        \subsubsection{Wiring/Cables/Connectors}
            ...
            \begin{figure}[H]
                ...
                \caption{\hl{Interlocks contained in the shutdown circuit}}
    ...
    \subsection{Pre-Charge Circuitry}
        ...
        \end{sidewaysfigure}
            ...
            \begin{table}[H]
                ...
                Continous power rating & \begin{tabular}[c]{@{}l@{}}Same as motor controller, \\ 14.4 kW\end{tabular} \\ \hline
                Overload power rating & \begin{tabular}[c]{@{}l@{}}Same as motor controller, \\ 54kW\end{tabular} \\ \hline
                Voltage rating & 150VDC \\ \hline
    ...
    \subsection{Discharge Circuitry}
        ...
        \subsubsection{Wiring, Cables, Current Calculations, Connectors}
            ...
            \begin{tabular}{|l|l|}
            \hline
            Resistor type & \hl{WH} Series \\ \hline
            Resistance & 220 \ohm \\ \hline
            Continuous power rating & \hl{50}W \\ \hline
            ...
            At peak power, the discharge resistor should be dissipating 44.82 W. \hl{The power rating of the resistor is higher than the peak power it will see.}
    ...
    \subsection{HV Disconnect (HVD)} \label{hvdsection}
        ...
        \subsubsection{Position in Car}
            ...
            \hl{New location}          
        %   This eliminates the need to splice high power lines. The HVD will be clearly indicated and located higher than 350mm from the ground, as per EV 4.7.1. The junction box will be rigidly mounted to the chassis.

        \begin{figure}[H]
            \centering
            \includegraphics[width = 0.6 \textwidth]{hvd_position}
            \caption{\hl{Position of the HVD in the vehicle. It is located in line with TS+, and is attached to the accumulator in the back of the vehicle. }}
            \label{hvdlocation}
        \end{figure}
...
\section{Accumulator}
    ...
    \subsection{Accumulator Pack 1} \label{Battery1}
        ...
        \subsubsection{Overview/Description/Parameters} \label{batteryoverview}
            ...
            Maximum nominal current & \h{NDA} \\ \hline
            Maximum charging current & 20 A \\ \hline
        ...
        \subsubsection{Cell Description} \label{celldescription}
            ...
            Cell nominal capacity & \hl{32.2} Ah \\ \hline
            Maximum Voltage & \hl{4.15V} \\ \hline
            Nominal Voltage & 3.75V \\ \hline
            Minimum Voltage & 2.5V \\ \hline
            Maximum output current & Unknown \\ \hline
            Maximum nominal output current & \hl{NDA} \\ \hline
            Maximum charging current & \hl{NDA} \\ \hline
            Maximum Cell Temperature (discharging) & \hl{NDA, see below} \\ \hline
            Maximum Cell Temperature (charging) & \hl{NDA, see below}\\ \hline
...
`   In software, we are restricting the maximum cell temperature (charging) to 50     \degree C, and the maximum cell temperature (discharging) to 60 \degree C. 
        ...
        \subsubsection{Battery Management System} \label{bms}
           ...
           The AMS monitors 6 groups of cells in series. Each module contains 4 cells, 2 series x 2 parallel, so each AMS monitors 3 modules, or 12 cells (6 series x 2 parallel). There are 4 AMS boards. Each AMS board is coupled to a cell breakout board, which includes 3 thermistors and bolts to the power terminals of three modules, as shown in Figure \ref{busbar} (blue circuit boards). The purpose of the cell breakout boards is to help manage wiring inside the accumulator. The cell breakout boards will have compression limiting copper pads at the terminal bolts and will be spaced above the bus bars using copper washers.\\
            ...
            The AMS shunts 3 A when the cell gets above 4.0 V. The AMS opens a relay in line with the shutdown circuit if any cell drops below 2.5 V. The AMS opens a relay in line with the shutdown circuit if any cell gets above 60 \degree C.\\
            ...
            \begin{figure}[H]
                ...
                \caption{\hl{Cell Breakout Board PCB Layout for the left hand side Note the fuses labeled with "F" and then a number. There is only TS voltage on this PCB.}} %The terminals left unconnected will be connecting to the other module stacks, with a fuse in the middle from the segment separator connectors.}
                \label{celltopLH}
            \end{figure}
            ...
            \begin{figure}[H]
                ...
                \caption{\hl{Cell Breakout Board PCB Layout for the right hand side Note the fuses labeled with "F" and then a number. There is only TS voltage on this PCB.}}
                \label{celltopRH}
            \end{figure}
        ...
        \subsubsection{Wiring, Cables, Current Calculations, Connectors} \label{batteryconnectors}
            ...
            \begin{tabular}{|l|l|}
            \hline
            Wire type & \hl{CnC Tech}, 22 AWG \\ \hline
            ...
            We will use OEM maintenance plugs provided by General Motors. As shown in Figure \ref{msd03}, these maintenance plugs, known internally as Manual Service Disconnects (MSD's), comprise a panel-mounted plastic housing (black) and a plastic plug (orange). The plug must be twisted and then pulled in two distinct steps, which disengages the copper bus-bar, contained in the orange plug, from spring-loaded contacts contained in the black housing. The orange plug also houses a fuse. We are expecting that this fuse will be rated significantly higher (350 A) than the TS fuse we specify, but we are expecting a datasheet from General Motors to confirm. General Motors will also be crimping custom length leads onto these MSD's for our vehicle. The leads are 40 mm$^2$ in cross-section, not including insulation. Each MSD also contains a two-pin interlock, as described in Section \ref{interlocks}. To the best of our knowledge, these MSD's comply with EV 3.3.3. Additionally, the spring-loaded contacts located in the black housing are encapsulated in plastic, providing protection from shorting and accidental contact.
        ...
        \subsubsection{Fusing} \label{fusing}
            ...
            \begin{tabular}{|l|l|}
            \hline
            Fuse manufacturer and type: & Midget Fuse, SPF type \\ \hline
            Continuous current rating & 4A \\ \hline
            Maximum operating voltage & 1000 V \\ \hline
            Type of fuse & Fast acting \\ \hline
            I2t rating & \begin{tabular}[c]{@{}l@{}}@10kA: 76.270, \\ @20kA: 80.254\end{tabular} \\ \hline
            \begin{tabular}[c]{@{}l@{}}Interrupt Current (max. current\\ at which the fuse can interrupt\\ the circuit)\end{tabular} & 20 kA \\ \hline
            \end{tabular}
            \caption{GLV Main fuse, SPF type}
            \label{glvfusetable}
            \end{table}
            
            %%Decide if the full 5V system gets one fuse or not
            %don't forget to modify full fuse table
            
            \begin{table}[H]
            \centering
            \begin{tabular}{|l|l|}
            \hline
            Fuse manufacturer and type & Busmann, ABC Series \\ \hline
            Continuous current rating & 1 A \\ \hline
            Maximum operating voltage & 125V \\ \hline
            Type of fuse & Fast acting \\ \hline
            I2T rating &   0.4310 \\ \hline
            \begin{tabular}[c]{@{}l@{}}Interrupt Current (max.,current\\ at which the fuse can interrupt\\ the circuit)\end{tabular} & 10kA \\ \hline
            \end{tabular}
            \caption{Fuse from 5V source to CAN nodes microcontrollers and the fuse to the IMD and light DC-DC converter, ABS Series}
            \label{canfusetable}
            \end{table}
            ...
            \begin{tabular}[c]{@{}l@{}}Module to module \\ (within accumulator) x3\end{tabular} & Busbars, 0.125"x0.750"& 200-249A & 3x Unknown & Unknown \\ \hline
            ...
            \begin{tabular}[c]{@{}l@{}}TS+ to IMD and TSAL's DC-DC\\ converter\end{tabular} & 22 AWG & 7A & ABC fuse & 1A \\ \hline
            ...
            Module internal fuses are currently unknown. Datasheets for fuses contained within the MSD's are pending from General Motors. Busbar ampacity was found using a chart from StormCopper in section \ref{fusingappendix} of the appendix. 
        ...
        \subsubsection{Charging} \label{charging}
            ...
            This UL-listed charger supplies constant current at 17.0A until cell voltages reach 4.15V. Then, constant voltage is supplied at 4.15 V until the current tapers to 2.0 A.\\
            
            The charger will indicate complete on its LED display when the battery voltage reaches 4.143V per cell, however it will continue charging until it finishes both stages.\\
...
\section{Motors} \label{Motors}
    ...
    \subsection{Motor 1} \label{M1}
        ...
        \subsubsection{Description, Type, Operating Parameters}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width = 0.8 \textwidth]{motor_isorear}
...
\section{Firewall}
    ...
    \subsection{Firewall 1}
        ...
        \subsubsection{Description/Materials}
            ...
            The firewall is constructed of two layers. The layer facing the tractive system is 5 mm Aluminum sheet metal, with a chamfered edge. The second layer facing the cockpit is 1/8 in. Flame-Retardant Multipurpose Garolite (G-10/FR4). The assembly is fastened together using sheet metal rivets. The chassis has welded sheet metal tabs that fasten to the firewall with bolts and lock nuts. Because the firewall is fastened to the chassis using conductive fasteners it is connected to GLV ground.\\
...
\section*{11.2.8.2 Tractive System Measuring Points}
...
\href{http://www.vishay.com/docs/31800/alsralvr.pdf}{5K, 1W resistors for the TSMP datasheet here}.

\href{http://www.mouser.com/ds/2/159/D72930_02_10_06-21562.pdf}{Red and Black TSMP 4mm banana jack datasheet here}.

\section*{11.2.9 Precharge System} \label{prechargeappendix}
...
\href{http://www.mallory-sonalert.com/Specifications/SC648AJR.pdf}{Ready to drive sound buzzer datasheet}.
...
\section*{11.3.1.5 Accumulator Monitoring System}  \label{amsappendix}
            \begin{sidewaysfigure}[p]
                \includegraphics[width=\textheight]{BMS_Schem}
...
\href{http://www.allfuses.com/media/documents/Bussmann\%20LPJ\%20(70-600A).pdf}{Full Bussman Fuse (175A) datasheet here}.

\href{http://www.stormcopper.com/design/Ampacity-Quick-Chart.htm}{StormCopper Busbar Ampacity Chart}. Referred from section \ref{fusing}.

\href{http://www.allfuses.com/media/documents/Ferraz\%20A15QS.pdf}{Keyswitch Fuse datasheet, Semiconductor AC A15QS}.

\href{http://www.allfuses.com/media/documents/Bussmann\%20ABC.pdf}{CAN fuse and IMD and Lights' DC-DC converter fuse, 1A and ABC type}.

\href{http://www.allfuses.com/media/documents/Littelfuse_Fuse_Solar_SPF_Datasheet.pdf}{GLV main fuse, 2A SPF type}.

\href{http://belfuse.com/pdfs/C1Q.pdf}{Cell to BMS fuse, C1Q type}.

    \begin{sidewaysfigure}[p]
        \includegraphics[height = 0.6 \textheight]{WireGaugeChart}
