...
\section{Accumulator}
   ...
   In software, we are restricting the maximum cell temperature (charging) to 50 \degree C, and the maximum cell temperature (discharging) to 60 \degree C.
        ...
        \subsubsection{Charging} \label{charging}
            ...
            This UL-listed charger supplies constant current at 17.0A until cell voltages reach 4.15V. Then, constant voltage is supplied at 4.15 V per cell, summing to 99.6V, until the current tapers to 2.0 A.\\
